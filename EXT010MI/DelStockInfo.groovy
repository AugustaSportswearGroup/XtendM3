/**
 * README
 * This extension is being used to Delete records from EXTPCE table. 
 *
 * Name: EXT010MI.DelStockInfo
 * Description: Deleting records from EXTPCE table
 * Date	      Changed By                      Description
 *20230627  SuriyaN@fortude.co    Deleting records from EXTPCE table
 *
 */

public class DelStockInfo extends ExtendM3Transaction {
  ...
  public DelStockInfo(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
  ...
  /**
   *Delete records from EXTPCE table
   * @params 
   * @return 
   */
  public deleteRecord() {
