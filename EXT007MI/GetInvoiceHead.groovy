/**
 * README
 * This extension is being used to Get records from EXTIHH table. 
 *
 * Name: EXT007MI.GetInvoiceHead
 * Description: Get records from EXTIHH table
 * Date	      Changed By                      Description
 *20230210  SuriyaN@fortude.co     Get records from EXTIHH table
 *
 */

public class GetInvoiceHead extends ExtendM3Transaction {
  ...
  public GetInvoiceHead(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
  ...
  /**
   *Get records from EXTIHH table
   * @params 
   * @return 
   */
  public getRecord() {
    DBAction query = database.table("EXTIHH").selection("EXIVNO", "EXHSEQ", "EXIVTP", "EXM3RG", "EXCUNO", "EXTRCD", "EXCUOR", "EXORNO", "EXORTP", "EXBTNM", "EXBTA1", "EXBTA2", "EXBTTO", "EXBTEC", "EXBTPO", "EXBTCS", "EXSTNM", "EXSTA1", "EXSTA2", "EXSTTO", "EXSTEC", "EXSTPO", "EXSTCS", "EXSHVI", "EXFOBC", "EXWHLO", "EXSHWT", "EXRSAD", "EXEMAL", "EXBTCN", "EXUPHO", "EXURUS", "EXUCSR", "EXBTA4", "EXSTA4", "EXORDT", "EXTRDT", "EXSHDT", "EXIVDT", "EXTXSA", "EXNTSA", "EXFRAM", "EXUIND").index("00").build()
