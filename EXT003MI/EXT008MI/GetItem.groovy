/**
 * README
 * This extension is being used to Get records from EXTITM table. 
 *
 * Name: EXT008MI.GetItem
 * Description: Get records from EXTITM table
 * Date	      Changed By                      Description
 *20230213  SuriyaN@fortude.co     Get records from EXTITM table
 *
 */
...
public class GetItem extends ExtendM3Transaction {
    ...
    public GetItem(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
        this.mi = mi
