/**
 * README
 * This extension is being used to List records from EXTCUS table. 
 *
 * Name: EXT610MI.LstCustomerData
 * Description: Listing records to EXTCUS table
 * Date	      Changed By                      Description
 *20230519  SuriyaN@fortude.co      Listing records from  EXTCUS table
 *
 */

public class LstCustomerData extends ExtendM3Transaction {
  ...
  public LstCustomerData(MIAPI mi, DatabaseAPI database, ProgramAPI program,MICallerAPI miCaller) {
    this.mi = mi
  ...
  /**
   *List records from EXTCUS table
   * @params 
   * @return 
   */
  public listRecord() {
