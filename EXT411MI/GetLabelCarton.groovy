/**
 * README
 * This extension is being used to Get records from EXTSLB table. 
 *
 * Name: EXT411.GetLabelCarton
 * Description: Get records from EXTSLB table
 * Date	      Changed By                      Description
 *20230831  SuriyaN@fortude.co     Get records from EXTSLB table
 *
 */

public class GetLabelCarton extends ExtendM3Transaction {
  ...
  public GetLabelCarton(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
