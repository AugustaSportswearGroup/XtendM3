...
public class GetFeatureOptn extends ExtendM3Transaction {
  private final MIAPI mi
  private final DatabaseAPI database
  private final ProgramAPI program
  private final MICallerAPI miCaller

  private String iFACI, iSTRT, iPRNO, iITNO, SIDI, FTID, OPTN, QBMVC1, QBMVC2, QBMVC3,
  QBMVC4, QBMVC5, QBMVC6, QBMVC7, QBMVC8, QBMVC9, QAMCC1, QAMCC2, QAMCC3, QAMCC4, QAMCC5, QAMCC6, QAMCC7, QAMCC8,
 QAMCC9, ITCL, feature2, option2 = ""
  ...
  public GetFeatureOptn(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
   ...
   * @return
   */
  public getMaterialAndOperationDetails() {
   ...
   * @return
   */
  public void getMatrixIdentityDetails(String SIDI) {
   ...
   * @return
   */
  public void getMatrixDetails(String SIDI) {
    ...
    {
      expression = expression.like("QBMRC1", iITNO+"%")
    }
   ...
   * @return
   */
  public void getOperationOnMaterialLines() {
