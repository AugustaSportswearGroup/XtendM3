/**
 * README
 * This extension is being used to List records from EXTGLB table. 
 *
 * Name: EXT101MI.ListEDILabelHead
 * Description: Listing records to EXTGLB table
 * Date	      Changed By                      Description
 *20230825  SuriyaN@fortude.co      Listing records from  EXTGLB table
 *
 */

public class ListEDILabelHead extends ExtendM3Transaction {
  ...
  public ListEDILabelHead(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
  ...
  /**
   *List records from EXTGLB table
   * @params 
   * @return 
   */
  public listRecord() {
    ...
    if (!iDIVI.trim().isEmpty() && !iORNR.trim().isEmpty() && !iORNO.trim().isEmpty()) {
