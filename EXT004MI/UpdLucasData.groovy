...
public class UpdLucasData extends ExtendM3Transaction {
  ...
  private int iCONO, iTTYP, iBXNO, iWGTO, iTXID, iUD03
  private long iDLIX
  boolean validInput = true
  private Double iESTW, iACTW

  public UpdLucasData(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
  ...
  /**
   *Update records to EXTMKT table
   * @params 
   * @return 
   */
