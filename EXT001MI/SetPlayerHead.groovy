...
public class SetPlayerHead extends ExtendM3Transaction {
  ...
  private String iDIVI, iPLID, iORNR, iORNO, iOREF, iPLNM, iPLNU, iTEAM, iLEAG, iGRBY, iBGBY, iCUNO, iADID, iUDF1, iUDF2, iUDF3, iUDF4, iUDF5, iUDF6,playerID,iORDT
  private int iCONO
  ...
  public checkIfOrderExists()
  {
    ...
    {
      recordExists = true
      def  params = ["CONO": iCONO.toString().trim(),"DIVI":iDIVI.toString().trim(),"PLID":iPLID.toString().trim()
