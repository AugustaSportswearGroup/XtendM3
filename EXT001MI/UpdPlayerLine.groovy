...
public class UpdPlayerLine extends ExtendM3Transaction {
  ...
  Closure < ? > updateCallBack = {
    LockedResult lockedResult ->
      ...
      if (mi.inData.get("POSX")!=null&&!mi.inData.get("POSX").trim().isEmpty()) {
      ...
      if (mi.inData.get("RORL")!=null&&!mi.inData.get("RORL").trim().isEmpty()) {
        lockedResult.set("EXRORL", iRORL)
      }
      if (mi.inData.get("RORX")!=null&&!mi.inData.get("RORX").trim().isEmpty()) {
