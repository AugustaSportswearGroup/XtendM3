/**
 * README
 * This extension is being used to Get records from EXTCCF table. 
 *
 * Name: EXT611MI.GetEDICustomer
 * Description: Get records from EXTCCF table
 * Date	      Changed By                      Description
 *20230913  SuriyaN@fortude.co     Get records from EXTCCF table
 *
 */

public class GetEDICustomer extends ExtendM3Transaction {
  ...
  public GetEDICustomer(MIAPI mi, DatabaseAPI database, ProgramAPI program, MICallerAPI miCaller) {
    this.mi = mi
